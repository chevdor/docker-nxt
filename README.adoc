...
To update from a version to the next, you can use a volume. First start the first container, then start the second with the updated version, pointing to your volume.
